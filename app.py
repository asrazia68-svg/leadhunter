...
<style>
    ...
    .stSelectbox select { background-color: #21262d !important; color: #e6edf3 !important; border: 1px solid #30363d !important; }
    ...
    .stSpinner { color: #e6edf3 !important; }
...
if page == "🏠  Dashboard":
        ...
        <div style='background:#161b22; border:1px solid #30363d; border-radius:8px; padding:16px;'>
            ...
            <div style='display:grid; grid-template-columns:1fr 1fr; gap:8px;'>
                <div style='background:#21262d; border:1px solid #30363d; border-radius:6px; padding:10px; display:flex; align-items:center; gap:8px;'>
                    ...
                    <div><div style='color:#e6edf3; font-size:12px;'>YouTube</div><div style='color:#7d8590; font-size:10px;'>Extract leads</div></div>
                </div>
                <div style='background:#21262d; border:1px solid #30363d; border-radius:6px; padding:10px; display:flex; align-items:center; gap:8px;'>
                    <span style='font-size:18px;'>📸</span>
                    <div><div style='color:#e6edf3; font-size:12px;'>Instagram</div><div style='color:#7d8590; font-size:10px;'>Extract leads</div></div>
                </div>
                <div style='background:#21262d; border:1px solid #30363d; border-radius:6px; padding:10px; display:flex; align-items:center; gap:8px;'>
                    <span style='font-size:18px;'>💼</span>
                    <div><div style='color:#e6edf3; font-size:12px;'>LinkedIn</div><div style='color:#7d8590; font-size:10px;'>Extract leads</div></div>
                </div>
                <div style='background:#21262d; border:1px solid #30363d; border-radius:6px; padding:10px; display:flex; align-items:center; gap:8px;'>
                    <span style='font-size:18px;'>🌐</span>
                    <div><div style='color:#e6edf3; font-size:12px;'>Website</div><div style='color:#7d8590; font-size:10px;'>Scrape leads</div></div>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div style='background:#161b22; border:1px solid #30363d; border-radius:8px; padding:16px;'>
            <div style='color:#e6edf3; font-weight:500; margin-bottom:12px;'>🕐 Recent Searches</div>
            <div style='display:flex; flex-direction:column; gap:8px;'>
                <div style='color:#7d8590; font-size:12px;'>🏢 Digital Agency</div>
                <div style='color:#7d8590; font-size:12px;'>🏠 Real Estate</div>
                <div style='color:#7d8590; font-size:12px;'>💻 SaaS</div>
                <div style='color:#7d8590; font-size:12px;'>🛒 E-commerce</div>
                <div style='color:#7d8590; font-size:12px;'>💪 Fitness</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        chart_data = pd.DataFrame({
            "Leads": [800, 1200, 900, 1800, 1400, 1100, 1600]
...
elif page == "✅  Email Verifier":
    st.markdown("<h2 style='color:#e6edf3;'>✅ Email Verifier</h2>", unsafe_allow_html=True)
    email = st.text_input("Enter Email", placeholder="e.g. john@company.com")
    ...
    st.markdown("<h2 style='color:#e6edf3;'>📤 Exports</h2>", unsafe_allow_html=True)
    data = {
        "Name": ["John Smith", "Emma Wilson", "David Lee"],
        "Email": ["john@tech.com", "emma@growth.com", "david@ai.com"],
        "Company": ["TechSolutions", "GrowthLab", "AI Startups"]
    }
    df = pd.DataFrame(data)
    st.dataframe(df, use_container_width=True, hide_index=True)
